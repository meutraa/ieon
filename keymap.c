...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_IEON] = LAYOUT_planck_grid(
		...
		KC_TAB,  _______, KC_LALT, KC_LGUI, MO(_LOWER), KC_SPC,  KC_ENT, MO(_RAISE), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
    ),

    [_LOWER] = LAYOUT_planck_grid(
        _______, KC_BSLS, KC_PERC, KC_SLSH, _______, _______, _______, _______, KC_V,    KC_Z,    _______, _______,
    ...
    [_ADJUST] = LAYOUT_planck_grid(
        NORMAL, FF, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
